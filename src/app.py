...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training, drills, and friendly matches",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["noah@mergington.edu", "liam@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice fundamentals and play scrimmage games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "isabella@mergington.edu"]
    },
    "Painting Workshop": {
        "description": "Explore acrylic and watercolor painting techniques",
